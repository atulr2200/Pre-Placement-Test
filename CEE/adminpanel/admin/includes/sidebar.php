                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddAllExaminee">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Add All Examinee
                                    </a>
                                </li>
                                ...
                                <li class="app-sidebar__heading">MANAGE FACULTY</li>
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddFaculty">
                                        <i class="metismenu-icon pe-7s-add-user">
                                        </i>Add Faculty
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-faculty">
                                        <i class="metismenu-icon pe-7s-users">
                                        </i>Manage Faculty
                                    </a>
                                </li>
