...
<!-- Add All Examine-->
<div class="modal fade" id="modalForAddAllExaminee" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addAllExaminee" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add All Examinee</h5>
...
<div class="modal fade" id="modalForAddFaculty" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addFacultyFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="" name="exam_cat" id="exam_cat" class="form-control" placeholder="Input Category" autocomplete="off">
            </div>
          <fieldset>
